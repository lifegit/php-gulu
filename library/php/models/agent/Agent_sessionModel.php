...
class Agent_sessionModel{
    ...
    private function init(){
        ...
        if(!$this->session_redis->init(System::REDIS_SESSION_HOST,System::REDIS_SESSION_PORT,System::REDIS_SESSION_PASSWORD,System::REDIS_SESSION_DBINDEX,'token_task_agent',1800,0,true,'/','',false,false)){
